...
class SettingsPage
{
    ...
    public function enqueue_assets(string $hook): void
    {
        ...
        wp_add_inline_script(
            ...
            const rateLimitSettings = ' . wp_json_encode(
                array_merge(
                    $cm_settings,
                    [ 'codemirror' => array_merge($cm_settings['codemirror'], [ 'lineNumbers' => true ]) ]
                )
            ) . ';
    ...
    public function register_settings(): void
    {
        register_setting(
            ...
            [ $this, 'sanitize_tokens' ]
        );

        register_setting(
            'wsp_options_group',
            'wsp_rate_limits_json',
            [ $this, 'sanitize_rate_limits' ]
        );
    ...
    public function field_tokens(): void
    {
        ...
        ?>
        <textarea name="wsp_allowed_tokens_json" id="wsp_allowed_tokens_json" rows="6" class="large-text code"><?php
    ...
    public function field_rate_limits(): void
    {
        ...
        ?>
        <textarea name="wsp_rate_limits_json" id="wsp_rate_limits_json" rows="18" class="large-text code"><?php
        echo esc_textarea($value);
        ?></textarea>
        <p class="description">
